    ...
    <div className="flex min-h-screen items-center justify-center px-5">
      <div className="w-full max-w-sm space-y-8 text-center">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 rounded-2xl bg-white/[0.04] ring-1 ring-white/[0.08] px-6 py-4 text-sm font-medium text-white/80 hover:bg-white/[0.08] transition-all cursor-pointer"
        >
